...
import Back7 from '../../images/background/banner-bg-1.jpg'
...
class productengineering extends Component {
  ...
  render() {
      return (
        ...
        <div className="image-layer" style={{ background: `url(${Back7})`}}></div>
                        ...
                        <div className="sidebar-widget services-widget">
                            <div className="widget-inner">
                                <ul>
                                    ...
                                    <li className="active"><a href="productengineering">Product Engineering</a></li>
                  ...
                  <div className="sidebar-widget info-widget">
                      ...
                      <div className="image"><a href="#"><img src={require('../../images/resource/featured-image-4.jpg')} alt=""/></a></div>
                                <div className="lower">
                                    ...
                                    <div className="phone"><a href="tel:+91 89035 00142">+91 89035 00142</a></div>

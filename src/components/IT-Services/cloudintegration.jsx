...
import Back5 from '../../images/background/banner-bg-1.jpg';
  ...
  render() {
      return (
        ...
        <section className="inner-banner alternate">
                  <div className="image-layer" style={{ background: `url(${Back5})` }}></div>
                        ...
                        <div className="sidebar-widget downloads-widget">
                            ...
                            <div className="widget-inner">
                                ...
                                <div className="lower">
                                    ...
                                    <div className="phone"><a href="tel:(+1)-8903500142">(+1) 8903500142</a></div>

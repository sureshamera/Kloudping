...
import Back4 from '../../images/background/banner-bg-1.jpg';
...
class Datainfrastructure extends Component {
  ...
  render() {
      return (
        ...
        <div className="image-layer" style={{ background: `url(${Back4})`}}></div>
                    ...
                    <aside className="sidebar services-sidebar">
                        <div className="sidebar-widget services-widget">
                            <div className="widget-inner">
                                <ul>
                                    <li className="active"><a href="Datainfrastructure">Data Infrastructure</a></li>
